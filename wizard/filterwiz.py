...
from filterpages import (LoadFilePage, CustomInputHeaderPage, FilterPage, SaveFilePage)
...
class FilterWizard(OdmltablesWizard):
    ...
    (PageLoadFile, PageCustomInputHeader,PageFilter,PageSaveFile) = range(NUM_PAGES)
